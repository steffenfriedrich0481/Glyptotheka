...
export const ThemeSelector: React.FC = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 rounded-lg bg-gray-800 shadow-xl border border-gray-700 z-50">
          <div className="p-2">
            <div className="text-xs font-semibold text-gray-400 px-3 py-2">COLOR THEME</div>
